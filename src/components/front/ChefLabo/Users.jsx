...
function Users({ onUserClick, onUserArtClick }) {
    ...
    const fetchData = async () => {
      if(userInfo && userInfo.labo_id) {
        try {
          const response = await axios.get(`/laboratoires/${userInfo.labo_id}/users`, {
            params: { equipe_id: selectedEquipe }
          });
